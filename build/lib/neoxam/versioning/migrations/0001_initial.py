    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adlobj', models.ForeignKey(blank=True, db_column='adlobj_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='versioning.adlobj')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_type', models.ForeignKey(db_column='ctype_id', on_delete=django.db.models.deletion.CASCADE, to='versioning.commenttype')),
            ],
            options={
                'db_table': 'comment',
            },
